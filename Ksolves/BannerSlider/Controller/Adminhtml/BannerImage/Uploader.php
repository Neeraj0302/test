...
class Uploader extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'path/image/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'path/image/' . $firstName . '/' . $secondName . '/';
            ...
            $imageResult['url'] = $mediaUrl . 'path/image/' . $firstName . '/' . $secondName . '/' . $newImageName;
        } catch (\Exception $e) {
